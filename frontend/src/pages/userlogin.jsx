...
setpassword('')
  ...
  return (
      ...
      <div className='p-7 flex flex-col justify-between h-screen'>
        ...
        <div>
          <Link to='/captain-login'   className='bg-[#2ed573] flex items-center justify-center text-white mb-5 rounded px-4 py-2 w-full text-lg font-semibold placeholder:text-base'>Sign in as Captain</Link>
        </div>
      </div>
