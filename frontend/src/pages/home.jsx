  ...
  return (
    <div className="h-screen relative">
      ...
      <div className="flex flex-col justify-end top-0 h-screen absolute w-full">
        ...
        >
          <Locationpanel setPanelOpen={setPanelOpen} vehiclePanel={vehiclePanelOpen} setvehiclePanelOpen={setvehiclePanelOpen}></Locationpanel>
          
        </div>
      </div>
      <div ref={vehiclePanelRef} className="fixed  bottom-0 translate-y-full w-full bg-white px-3 py-10 pt-14 z-10">
       ...
       <i className=' text-3xl text-gray-200 ri-arrow-down-wide-line'></i>
        ...
        <h2 className="text-2xl mb-5 font-semibold">Choose a Vehicle</h2>
<div className="flex border-2 border-black active:bg-gray-100 mb-2 rounded-xl w-full items-center p-3 justify-between">
